...
const store = routesStore.focusOn('createAssessment')
...
const Component: React.StatelessComponent<State> = (state) => <div>
...
export const CreateAssessment = connect(Component).to(store.state$)
